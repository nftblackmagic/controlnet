...
model_dl_urls = {
    ...
    "depth": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11f1p_sd15_depth.pth",
    "softedge": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_softedge.pth",
    "normal": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_normalbae.pth",
    "mlsd": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_mlsd.pth",
    "openpose": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_openpose.pth",
    "scribble": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_scribble.pth",
    "seg": "https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/control_v11p_sd15_seg.pth",
}
...
def download_model(model_name, urls_map):
    ...
    relative_path_to_model = model_url.replace("https://huggingface.co/lllyasviel/ControlNet-v1-1/blob/main/", "")
